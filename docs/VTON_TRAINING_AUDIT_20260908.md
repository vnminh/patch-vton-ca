...
> **Tài liệu lịch sử (2026-09-08):** số liệu dưới đây thuộc revision trước
> RGB+HF feature fusion. Không dùng file này để suy ra graph hoặc lệnh train hiện
> tại. Xem [`ARCHITECTURE_VI.md`](ARCHITECTURE_VI.md) cho model hiện hành và
> [`VTON_HF_CONTROL.md`](VTON_HF_CONTROL.md) cho lý do bỏ HF velocity độc lập.
